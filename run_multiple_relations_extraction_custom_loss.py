...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("predicate_head_select_loss"):
        ...
        # shape [batch_size, sequence_length, sequencd_length, predicate_label_numbers]
        predicate_custom_loss = tf.where(tf.greater(gold_predicate_matrix_one_hot, 0), predicate_score_matrix * 128, gold_predicate_matrix_one_hot)
        # shape []
        predicate_head_select_loss = tf.reduce_sum(predicate_custom_loss)
