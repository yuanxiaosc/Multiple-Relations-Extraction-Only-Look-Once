...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    with tf.variable_scope("predicate_head_select_loss"):
        ...
        predicate_embedding_weights = tf.get_variable("predicate_embedding_weights", [num_predicate_labels, 2])

        predicate_score_matrix_embed = tf.einsum('aijk,kp->aijp', predicate_score_matrix, predicate_embedding_weights)
        gold_predicate_matrix_one_hot_embed = tf.einsum('aijk,kp->aijp', predicate_score_matrix, predicate_embedding_weights)
